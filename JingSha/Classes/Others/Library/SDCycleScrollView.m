...
- (void)setPlaceholderImage:(UIImage *)placeholderImage
{
    ...
    bgView.image = self.placeholderImage;
...
- (void)setupPageControl
{
    ...
    switch (self.pageControlStyle) {
        case SDCycleScrollViewPageContolStyleAnimated:
        {
            ...
            pageControl.currentDotImage = [UIImage imageNamed:@"dsa"];
            pageControl.dotImage = [UIImage imageNamed:@"sa"];
...
- (void)layoutSubviews
{
    ...
    if (self.pageControlAliment == SDCycleScrollViewPageContolVertionCenter) {
        x = self.mainView.sd_width  - kUIScreenWidth / 2;
        y = self.mainView.sd_height - size.height - 60;
    }
    ...
    _pageControl.frame = CGRectMake(x - 10, y, size.width, size.height);
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (!cell.hasConfigured) {
        ...
        cell.isButtomTitleLabel = self.isButtomTitleLabel;
    }
