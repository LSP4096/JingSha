...
//	[self.layer setBorderColor:[ UIColor colorWithRed: 200/255.0  green: 148/255.0 blue: 62/255.0 alpha: 1.0].CGColor];
	...
	// Set the font
	_tickerFont = [UIFont systemFontOfSize:20.0];
...
-(void)animateCurrentTickerString
{
	...
	CGSize textSize = [currentString sizeWithFont:_tickerFont constrainedToSize:CGSizeMake(9999, self.frame.size.height) lineBreakMode:UILineBreakModeWordWrap];

//    CGSize textSize = [currentString boundingRectWithSize:CGSizeMake(self.width, MAXFLOAT) options:NSStringDrawingUsesLineFragmentOrigin | NSStringDrawingUsesFontLeading attributes:@{NSFontAttributeName:_tickerFont} context:nil].size;
	...
	[tickerLabel setFrame:CGRectMake(startingX, textSize.height/2, self.width, textSize.height)];
